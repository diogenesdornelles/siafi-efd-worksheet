...
export default function Tables() {
  ...
  return (
    <div className="grid grid-cols-1 xl:grid-cols-2 gap-8 border-t-2 pt-6 border-gray-800 transition-all">
      <div>
